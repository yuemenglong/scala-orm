...
//}
//
//abstract class CondFE(f1: Field, f2: Expr2) extends CondItem {
//  def op(): String
//
//  override def getSql: String = {
...
//}
//
//case class EqFE(f1: Field, f2: Expr2) extends CondFE(f1, f2) {
//  override def op(): String = "="
//}
//
...
//}
//
//case class NeFE(f1: Field, f2: Expr2) extends CondFE(f1, f2) {
//  override def op(): String = "<>"
//}
//
...
//}
//
//case class GtFE(f1: Field, f2: Expr2) extends CondFE(f1, f2) {
//  override def op(): String = ">"
//}
//
...
//}
//
//case class LtFE(f1: Field, f2: Expr2) extends CondFE(f1, f2) {
//  override def op(): String = "<"
//}
//
...
//}
//
//case class GteFE(f1: Field, f2: Expr2) extends CondFE(f1, f2) {
//  override def op(): String = ">="
//}
//
...
//}
//
//case class LteFE(f1: Field, f2: Expr2) extends CondFE(f1, f2) {
//  override def op(): String = "<="
//}
//
