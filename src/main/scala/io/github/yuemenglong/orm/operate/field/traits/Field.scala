...
/**
  ...
  */
trait FieldExpr2 extends Expr2 {
  def add(f: FieldExpr2): FieldExpr2 = FieldExpr2FF(this, f, "+")

  def add[V](v: V): FieldExpr2 = FieldExpr2FV(this, v, "+")

  def +(f: FieldExpr2): FieldExpr2 = FieldExpr2FF(this, f, "+")

  def +[V](v: V): FieldExpr2 = FieldExpr2FV(this, v, "+")

  def sub(f: FieldExpr2): FieldExpr2 = FieldExpr2FF(this, f, "-")

  def sub[V](v: V): FieldExpr2 = FieldExpr2FV(this, v, "-")
...
case class FieldExpr2FF(f1: FieldExpr2, f2: FieldExpr2, op: String) extends FieldExpr2 {
  override def getSql: String = s"${f1.getSql} ${op} ${f2.getSql}"

  override def getParams: Array[Object] = f1.getParams ++ f2.getParams
}

case class FieldExpr2FV[V](f1: FieldExpr2, v: V, op: String) extends FieldExpr2 {
